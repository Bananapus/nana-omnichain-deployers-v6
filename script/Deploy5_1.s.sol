...
contract Deploy is Script, Sphinx {
    ...
    function deploy() public sphinx {
        ...
        if (!_isDeployed(
                ...
                type(JBOmnichainDeployer5_1).creationCode,
                abi.encode(suckers.registry, hook.hook_deployer_5_1, core.permissions, core.projects, core.trustedForwarder)
            )) {
            new JBOmnichainDeployer5_1{salt: NANA_OMNICHAIN_DEPLOYER_SALT}(
                suckers.registry, hook.hook_deployer_5_1, core.permissions, core.projects, core.trustedForwarder
            );
        }
    }
